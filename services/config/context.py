...
class ProcessingContext:
    ...
    def __init__(self, task_id: str, video_path: str, src_lang: str, tgt_lang: str, output_folder: str):
    ...
    def get_srt_file(self, lang, is_lock) -> str:
        ...
        return os.path.join("transcriptions/", f"{video_hash}.{lang}.srt{'.lock' if is_lock else ''}")