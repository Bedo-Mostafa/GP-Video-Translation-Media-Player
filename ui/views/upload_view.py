...
class Upload(QWidget):
    def __init__(
        ...
        # self.file_html = "..//assets//animationLoader.html"
        # Path relative to the project root (CWD)
        path_to_animation_html = os.path.join("ui//assets", "animationLoader.html")
        self.file_html = path_to_animation_html # Store it if needed elsewhere, or use directly
    ...
    def reset_scene(self):
        ...
        self.upload_label.setText("Uploading video, please wait...")
        self.progress_bar.setValue(0)
        # path_to_animation_html = os.path.join("assets", "animationLoader.html") 
