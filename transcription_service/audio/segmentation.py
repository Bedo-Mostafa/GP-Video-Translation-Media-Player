...
@performance_log
def detect_silent_points(audio_path: str, min_silence_duration: float = 0.7, silence_threshold_db: float = -35) -> List[float]:
...
@performance_log
def segment_audio(audio_path: str, video_path: str, min_silence_duration: float, silence_threshold: float) -> List[float]:
...
@performance_log
def create_segment_jobs(silent_points: List[float], video_duration: float) -> List[Tuple[float, float, int]]:
...
@performance_log
def cut_audio_segment(input_audio: str, output_path: str, start_time: float, end_time: float) -> str:
